...
class ImageBlock(StructBlock):
    ...
    credit_name = CharBlock(required=False, help_text="Name of the image source")
    credit_url = URLBlock(required=False, help_text="URL of the image source")
    caption = CharBlock(required=False, help_text="Caption to appear beneath the image")
...
class BannerBlock(StructBlock):
    ...
    text = StreamBlock(
        [
            (
                "text_heading",
                CharBlock(
                    template="blocks/banner/text_heading.html",
                    required=False,
                    icon="title",
                ),
            ),
            ...
            (
                ...
                ListBlock(
                    StructBlock(
                        [
                            (
                                ...
                                TextBlock(
                                    required=False,
                                    help_text="An optional title to the list item",
                                ),
                            ),
                            (
                                "content",
                    ...
                    template="blocks/banner/list.html",
                    icon="list-ul",
                ),
            ),
        ]
    ...
    light = BooleanBlock(
        required=False,
        default=False,
        help_text="Sets the background to a lighter colour",
    )
