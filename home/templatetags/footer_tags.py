...
def get_footer_sections(context, parent, calling_page=None):
    ...
    for footer_section in footer_sections:
        footer_section.links = footer_section.footer_section_links.all().order_by(
            "sort_order"
        )

        footer_section.social_links = footer_section.footer_social_links.all().order_by(
            "sort_order"
        )
...
def get_footer_text():
    ...
    return {"footer_text": footer_text, "footer_text_major": footer_text_major}
